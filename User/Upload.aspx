...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <p>
        ...
        <asp:LinkButton ID="LinkButton1" runat="server">current inventory</asp:LinkButton>
&nbsp;for simple editing.<br />
        <br />
        Please include all fields if uploading a new part.<br />
        Please match part descriptions when updating existing items.<br />
        (It&#39;s a lot easier if you download the current inventory first, then edit in 
        excel.)<br />
        <br />
...
&nbsp; <asp:Button ID="Button3" runat="server" Text="GO" />
        ...
        <asp:CheckBox ID="chkOverWrite" runat="server" 
            Text="Overwrite Inventory with Update" />
        <br />
        <br />
        </asp:Content>
